...
- the mean of the normal distribution is $g(y \vert x) = \beta_0 + \beta_1 x$;
- the variance of the normal distribution is $\sigma^2$, which is a constant (i.e., does not vary with $x$)

Our goal is to estimate the mean: $E[Y \vert x] = \beta_0 + \beta_1 x$. The set of means, for all $x$, is the "regression line."
...
So, when we apply generalized linear regression in this context, we would identify the family as Poisson. (Why I point this out will make more sense Thursday when I show glm examples.)
...
Case 3 is special, and we'll look at it more on Thursday.
