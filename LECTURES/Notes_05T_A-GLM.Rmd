...
- $x$ may take on continuous values and/or discrete values over the domain of $f(x \vert \theta)$;
...
The normal distribution doesn't hold here. Any idea of what distribution could possibly govern $Y \vert x$? (Remember, we might not know truly how $Y \vert x$ is distributed, but any assumption we make *should* fit with the limitations imposed by points 1 and 2 above.)
